...
function sum(a, b) {
  //eslint-disable-line
  let value = a + b;
  let value2 = `The sum of ${a} and ${b} is 11.`;
  return [value, value2];
}
...
function multiply(a, b) {
  //eslint-disable-line
  let product = a * b;
  let value2 = `The product of ${a} and ${b} is ${product}.`;
  return [product, value2];
}
...
and when you think it is finished, uncomment the call for the testSumAndMultiply() 
...
function sumAndMultiply(a, b, c) {
  ...
  let sum = a + b + c;
  let product = a * b * c;
  let value2 = `${a} and ${b} and ${c} sum to ${sum}.`;
  let value3 = `The product of ${a} and ${b} and ${c} is ${product}.`;
  return [sum, product, value2, value3];
}
...
function sumArray(sumArr) {
  ...
  let string = `${arr1[0]},${arr1[1]},${arr1[2]} was passed in as an array of numbers, and ${sum} is their sum.`;
  return [sum, string];
}
...
function multiplyArray(multArr) {
  //eslint-disable-line
  let arr2 = multArr;
  let prod = arr2[0] * arr2[1] * arr2[2];
  let string = `The numbers ${arr2[0]},${arr2[1]},${arr2[2]} have a product of ${prod}.`;
  return [prod, string];
}
